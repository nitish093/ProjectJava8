...
public class StudentDataBase {
    ...
    public static Supplier<Student> supplier = () -> {
      return new Student("Adam",2,3.6, "male",Arrays.asList("swimming", "basketball","volleyball"),33);
    };
    /**
    ...
    public static List<Student> getAllStudents(){
         ...
         * 2nd grade students
         */
        Student student1 = new Student("Adam",2,3.6, "male",Arrays.asList("swimming", "basketball","volleyball"),22);
        ...
        Student student4 = new Student("Dave",3,3.9,"female", Arrays.asList("swimming", "gymnastics","soccer"),14);
        /**
         * 4th grade students
         */
